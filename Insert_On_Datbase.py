    ...
    while a == 0:
        try:
            ...
            # string_Translate_Table = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\">" + \
                                     ...
                                     # SegFeild[18] + "</td></tr>" + \
                                     # "<tr bgcolor=\"#ffffff\" onmouseover=\"this.style.backgroundColor='#def3ff'\" onmouseout=\"this.style.backgroundColor=''\"><td style=\"padding:7px;\">Attachment </td><td style=\"padding:7px;\">""<a href="+SegFeild[5]+" target=\"_blank\">View</a>""</td></tr>" + "</td></tr></table>"
            Final_Doc = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\"><BODY><style style=\"text/css\"> td{ padding:5px;}</style>" + get_htmlSource + "</BODY></HTML>"
